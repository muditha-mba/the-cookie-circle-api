...
class TaxCharge(Base, TimestampMixin):
    """Order-level tax or fee definition applied automatically when active."""

    __tablename__ = "tax_charges"
